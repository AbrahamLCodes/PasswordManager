...
import com.swtizona.passwordmanager.formactivities.*
import com.swtizona.passwordmanager.mainactivities.ui.main.SectionsPagerAdapter
import com.swtizona.passwordmanager.sidemenuactivities.InfoActivity
import com.swtizona.passwordmanager.sidemenuactivities.OptionsActivity
...
class HomeTabActivity : AppCompatActivity(),
            ...
            when (menuItem.itemId) {
                ...
                R.id.cuentaItem -> {
                    ...
                    if (db.getRowCount(usuarioIntent!!.getNombre(), "CORREOS") > 0) {
                        ...
                        Toast.makeText(
                            applicationContext,
                            "Si quieres registrar una contraseña sin correo, ve a la pestaña de Contraseñas",
                            Toast.LENGTH_LONG
                        ).show()
    ...
    private fun userHeader() {
        ...
        hu.text = "Usuario: " + user!!.getNombre()
    }
